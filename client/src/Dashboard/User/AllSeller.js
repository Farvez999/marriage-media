...
const AllSeller = () => {
    ...
    return (
        <>
            ...
            <h1 className='text-3xl font-bold text-center my-5 mb-20'>All Users</h1>
          {searchProfile.map((profile) => (
            <div className="right col-span-3 my-4 mx-2 border rounded-md shadow-2xl shadow hover:shadow-2xl">
