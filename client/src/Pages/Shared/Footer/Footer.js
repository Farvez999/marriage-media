        ...
        <div className='bg-lime-700'>
            <footer className="footer p-10 bg-base-200 bg-lime-700 text-base-content">
                <div>
                    ...
                    <a className="text-white text-left">Suite No: 9/38 (8th Floor),<br></br>
                        ...
                        Dhaka 1205</a>
                    <a className="link link-hover text-white"><BsFillTelephoneFill /> +880 1776711862</a>
                    <a className="link link-hover text-white">+880 1776711862</a>
                    <a className="link link-hover text-white"> support1@sensiblematch.com</a>
                </div>
                <div>
            ...
            <footer className="footer px-10 py-4 border-t bg-base-200 bg-lime-700 text-base-content border-base-300">
                <div className="items-center grid-flow-col">
                    ...
                    <p className='text-white'>ACME Industries Ltd. All rights reserved.</p>
                </div>
