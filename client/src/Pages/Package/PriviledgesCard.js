            ...
            <div className="container px-2 mx-auto">
                ...
                <div className="flex flex-wrap items-stretch -mx-4">
                    ...
                    <div className="flex flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-900 bg-lime-400">
                        ...
                        <button type="button" className="inline-block px-5 py-3 font-semibold tracking-wider text-center rounded dark:bg-violet-400 bg-white dark:text-gray-900">Get Started</button>
                    </div>
                    {/* <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
